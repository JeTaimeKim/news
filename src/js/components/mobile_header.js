...
import { Menu, Icon ,message,Tabs,Form,Input,Button,CheckBox,Modal} from 'antd';
...
class MobileHeader extends React.Component{
  ...
  handleSubmit(e){
    ...
    +formData.r_password+'&r_confirmPassword='+formData.r_confirmPassword,myFetchOptions)
      ...
      <header>
              ...
              <Form horizontal onSubmit={this.handleSubmit.bind(this)}>
                ...
                <Form horizontal onSubmit={this.handleSubmit.bind(this)}>
                  ...
                  <FormItem label='确认密码'>
                    {getFieldDecorator('confirmPassword')(<Input type='password' placeholder='请再次输入您的密码' />)}
                  </FormItem>
